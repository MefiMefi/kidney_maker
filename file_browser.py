...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "肾表计算器"))
        self.open_path_text.setPlaceholderText(_translate("Form", "请输入排表的文件地址"))
        self.open_path_but.setText(_translate("Form", "浏览"))
        self.save_path_but.setText(_translate("Form", "浏览"))
        self.save_path_text.setPlaceholderText(_translate("Form", "请输入肾表的保存地址"))
