...
from calGoods import kidney_maker


class Ui_KidneyUI(object):
    def setupUi(self, KidneyUI):
        KidneyUI.setObjectName("KidneyUI")
        KidneyUI.resize(349, 271)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("logo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        KidneyUI.setWindowIcon(icon)
        KidneyUI.setWindowOpacity(1.0)
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(KidneyUI)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.contactLabel = QtWidgets.QLabel(KidneyUI)
        self.contactLabel.setWordWrap(True)
        self.contactLabel.setObjectName("contactLabel")
        self.verticalLayout_6.addWidget(self.contactLabel)
        ...
        self.verticalLayout_4.addWidget(self.stepThreeLabel)
        ...
        self.horizontalLayout_3.addWidget(self.placeHolder1)
        ...
        self.horizontalLayout_3.addWidget(self.placeHolder2)
        ...
        self.verticalLayout_3.addWidget(self.readmeLink)
    ...
    def retranslateUi(self, KidneyUI):
        _translate = QtCore.QCoreApplication.translate
        KidneyUI.setWindowTitle(_translate("KidneyUI", "自动肾表机"))
        self.contactLabel.setText(_translate("KidneyUI", "如程序意外推出或未生成肾表，请加qq群【995388035】反馈，谢谢！"))
        self.label.setText(_translate("KidneyUI", "【Step-1】选择肾表文件"))
        ...
        self.readmeLink.setText(_translate("KidneyUI",
                                           "<html><head/><body><p><a href=\"www.baidu.com\"><span style=\" text-decoration: underline; color:#0000ff;\">教程链接</span></a></p></body></html>"))
