...
class Ui_KidneyUI(object):
    ...
    def retranslateUi(self, KidneyUI):
        ...
        self.readmeLink.setText(_translate("KidneyUI", "<html><head/><body><p><a href=\"https://docs.qq.com/doc/DSVhXS3BST1NQd0tv\"><span style=\" text-decoration: underline; color:#0000ff;\">教程链接</span></a></p></body></html>"))
